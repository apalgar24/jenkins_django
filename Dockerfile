...
RUN pip install django mysqlclient && git clone https://github.com/apalgar24/jenkins_django.git /usr/src/app && mkdir static && apt-get clean && rm -rf /var/lib/apt/lists/*
